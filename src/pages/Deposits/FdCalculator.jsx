        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-md-7">
              <h1 className="fw-bold display-5">Fixed Deposit (FD)</h1>
      ...
      <section className="py-5">
        <div className="container text-center">
          <h3 className="fw-bold mb-4">
            Get Maximum Benefits from Fixed Deposit Investment
          </h3>
          <div className="row g-4">
            {[
              {
                title: "Additional Interest Rate",
                desc: "Senior Citizen FD is at +0.50% of additional interest rate",
              },
              {
                title: "Overdraft Against FD",
                desc: "Avail Overdraft against FD for emergencies",
              },
              {
                title: "Choose Tenure with Max Interest Rate",
                desc: "Tenures of 2 years 1 day to 10 years avail maximum interest rate of 6.60% p.a.",
              },
              {
                title: "Instant FD Creation",
                desc: "Now create an FD online anytime, anywhere within 60 seconds",
              },
            ].map((item, i) => (
