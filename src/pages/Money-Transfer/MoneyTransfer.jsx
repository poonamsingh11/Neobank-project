...
const MoneyTransferPage = () => {
  return (
   <Container fluid className="bg-light min-vh-100 px-0">
      ...
      <div style={{ paddingTop: '0rem' }}></div>
<Row className="justify-content-center mb-5">
  <Col
  className="text-center p-4 rounded"
  style={{ backgroundColor: "#900603" }}
>
    <h1 className="text-white mb-2">Money Transfer</h1>
    <p className="mb-2 text-white mt-2">
  ...
  <Row className="mb-5">
      ...
      <FeatureCard
        ...
        description={
          <p className="text-muted small mb-0" style={{ lineHeight: "1.6" }}>
            Transfer money to bank accounts, UPI, or mobile wallets
          </p>
        }
        link="/send-money"
        icon={
    ...
    <Col xs={12} md={5} lg={3} className="mb-4">
      <FeatureCard
        ...
        description={
          <p className="text-muted small mb-0" style={{ lineHeight: "1.6" }}>
            Complete your KYC for higher transaction limits
          </p>
        }
        link="/kyc"
        icon={
    ...
    <Col xs={12} md={5} lg={3} className="mb-4">
      <FeatureCard
        ...
        description={
          <p className="text-muted small mb-0" style={{ lineHeight: "1.6" }}>
            Pay utility bills, mobile recharge, and more
          </p>
        }
        link="/pay-bills"
        icon={
    ...
    <Col xs={12} md={5} lg={3} className="mb-4">
      <FeatureCard
        ...
        description={
          <p className="text-muted small mb-0" style={{ lineHeight: "1.6" }}>
            View or upgrade your daily transaction limit
          </p>
        }
      ...
      <Card className="border-0 shadow-lg rounded-4">
        <Card.Body className="p-5">
          <div className="d-flex justify-content-between align-items-center mb-5">
            <div>
              <h3 className="fw-bold text-dark mb-2">Recent Transfers</h3>
          ...
          <div className="bg-light rounded-4 p-4 border">
            <div className="d-flex justify-content-between align-items-center">
              <div>
                <h4 className="h3 fw-semibold text-dark mb-2">Rahul Sharma</h4>
...
>
  Choose from NEFT, IMPS, RTGS, or UPI for sending money within India
        ...
        <div className="d-flex justify-content-center gap-3 mt-3 flex-wrap">
          ...
          <Badge bg="secondary" className="px-3 py-2 fs-6">RTGS</Badge>
  ...
  <Link to={link} className="text-decoration-none">
    ...
    >
      <Card.Body className="d-flex align-items-center p-4">
        ...
        <div>
          <Card.Title className="h4 fw-semibold mb-2 text-dark">
            {title}
          </Card.Title>
