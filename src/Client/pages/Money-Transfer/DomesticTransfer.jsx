...
const DomesticTransfer = () => {
  ...
  return (
    ...
    >
      <Card
        className="p-4 shadow-lg rounded-4 d-flex flex-column align-items-center text-center"
        style={{ minHeight: "400px", width: "100%", maxWidth: "500px" }}
      >
        {/* Icon */}
        <div
          className="d-flex align-items-center rounded-circle bg-light mb-3"
        ...
        <Row className="g-4 w-100" style={{ maxWidth: "500px" }}>
          <Col xs={6}>
            <Button
              ...
              style={buttonStyle}
              className="w-100 py-3 rounded-4 fw-semibold fs-6"
            >
              NEFT
            </Button>
          </Col>
        ...
        <Button
          onClick={() => navigate(-1)}
          className="mt-5 fw-semibold fs-6"
          style={{
