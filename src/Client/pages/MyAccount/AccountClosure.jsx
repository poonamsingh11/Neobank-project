      ...
      <Row className="justify-content-center">
        <Col md={10} lg={8}>
          <div className="row shadow-lg rounded-3" style={{ backgroundColor: "#fff" }}>
            {/* Left Branding Panel */}
            <Col md={4} className="d-flex flex-column justify-content-center align-items-center p-4" style={{ backgroundColor: "#900603", color: "#fff", borderTopLeftRadius: "15px", borderBottomLeftRadius: "15px" }}>
              <img src="src/assets/neobank-white.png" alt="Neo Bank Logo" className="img-fluid mb-3" style={{ maxHeight: 120 }} />
            ...
            <Col md={8} className="p-4">
                    ...
                    <div key={index} className="flex-fill text-center position-relative">
                      <div
                        className={`mx-auto rounded-circle d-flex align-items-center justify-content-center 
                          ${isActive ? "text-white" : "bg-light text-muted"}`}
                        style={{
                          width: 50,
                          height: 50,
                          fontWeight: "bold",
                      ...
                      {index < 3 && (
                        <div
                          style={{
                            ...
                            width: "100%",
                            height: "4px",
                            backgroundColor: currentStep > stepNumber ? "#900603" : "#d1d1d1",
                            zIndex: 0,
                          }}
                        />
                      )}
              ...
              <Card className="shadow-lg p-4">
                ...
                <div className="d-flex justify-content-between mt-4">
                  ...
                  {currentStep < 4 ? (
                    <Button style={{ background: "linear-gradient(90deg,#900603,#900603)", border: "none" }} className="px-4 py-2 rounded-pill fw-semibold" onClick={nextStep} disabled={currentStep === 1 && formData.accountNumber !== formData.confirmAccountNumber}>
                      Next Step →
                    </Button>
                  ) : (
                    <Button style={{ background: "linear-gradient(90deg,#900603,#900603)", border: "none" }} className="px-4 py-2 rounded-pill fw-semibold" onClick={handleSubmit} disabled={!formData.acknowledgment}>
                      ✅ Submit Request
                    </Button>
                  )}
                </div>
